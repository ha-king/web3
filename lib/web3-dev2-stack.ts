...
export class Web3Dev2Stack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    const bucket = new s3.Bucket(this, 'Web3Dev2AppBucket', {
      bucketName: `web3-dev2-app-${this.account}-${this.region}`,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
      autoDeleteObjects: true
    });

    const distribution = new cloudfront.Distribution(this, 'Web3Dev2Distribution', {
      defaultBehavior: {
    ...
    new s3deploy.BucketDeployment(this, 'DeployWeb3Dev2App', {
    ...
    new codepipeline.Pipeline(this, 'Web3Pipeline', {
      pipelineName: 'Web3-Shared-Pipeline',
      stages: [
        {
          stageName: 'Source',
          actions: [
    ...
    new cdk.CfnOutput(this, 'Dev2WebsiteURL', {
      value: `https://${distribution.distributionDomainName}`,
      description: 'Web3 Dev2 App URL'
    });
  }
}