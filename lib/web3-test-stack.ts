...
export class Web3TestStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    const bucket = new s3.Bucket(this, 'Web3TestAppBucket', {
      bucketName: `web3-test-app-${this.account}-${this.region}`,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
      autoDeleteObjects: true
    });

    const distribution = new cloudfront.Distribution(this, 'Web3TestDistribution', {
      defaultBehavior: {
    ...
    new s3deploy.BucketDeployment(this, 'DeployWeb3TestApp', {
    ...
    new codepipeline.Pipeline(this, 'Web3Pipeline', {
      pipelineName: 'Web3-Test-Pipeline',
      stages: [
        {
          stageName: 'Source',
          actions: [
    ...
    new cdk.CfnOutput(this, 'TestWebsiteURL', {
      value: `https://${distribution.distributionDomainName}`,
      description: 'Web3 Test App URL'
    });
  }
}