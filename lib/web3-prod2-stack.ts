...
export class Web3Prod2Stack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    const bucket = new s3.Bucket(this, 'Web3Prod2AppBucket', {
      bucketName: `web3-prod2-app-${this.account}-${this.region}`,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
      autoDeleteObjects: true
    });

    const distribution = new cloudfront.Distribution(this, 'Web3Prod2Distribution', {
      defaultBehavior: {
    ...
    new s3deploy.BucketDeployment(this, 'DeployWeb3Prod2App', {
    ...
    new codepipeline.Pipeline(this, 'Web3Pipeline', {
      pipelineName: 'Web3-Prod2-Pipeline',
      stages: [
        {
          stageName: 'Source',
          actions: [
    ...
    new cdk.CfnOutput(this, 'Prod2WebsiteURL', {
      value: `https://${distribution.distributionDomainName}`,
      description: 'Web3 Prod2 App URL'
    });
  }
}